...
4. 不要粘贴本周复盘原文、摘录或Markdown标题；只把稳定变化提炼进正文
5. 直接输出完整档案文本`;
...
4. 不要粘贴本月复盘原文、摘录或Markdown标题；只把稳定变化提炼进正文
5. 直接输出完整档案`;
...
规则：年复盘可以全面重构档案——删除明显过时的条目、升级、新增。保持四大区块结构。在末尾追加一句话版本日志。不要粘贴年度复盘原文、摘录或Markdown标题；只把稳定变化提炼进正文。直接输出完整档案。`;
