    ...
    zh: {
        ...
        settings: {
            ...
            storage: [
                ...
                { icon: "🤖", title: "AI 服务", desc: "AI 功能默认通过 DeepSeek 兼容接口调用，支持自定义 API Key。免费额度用完后，在设置中填入你自己的 DeepSeek Key 即可继续使用。" },
            ...
            apiKeyDesc: "填入你自己的 DeepSeek API Key，使用自定义模型，不受免费额度限制。",
            apiKeyPlaceholder: "sk-...",
            apiKeySaving: "保存中…",
            apiKeySave: "保存",
            apiKeySaved: "已保存 ✓",
            apiTitle: "账户 & API 额度",
            apiSub: "（超出后请配置您自己的 DeepSeek API Key）",
    ...
    en: {
        ...
        settings: {
            ...
            storage: [
                ...
                { icon: "🤖", title: "AI service", desc: "AI features use a DeepSeek-compatible API by default. You can add your own API Key in settings. The free quota covers 10 requests; after that, bring your own key." },
            ...
            apiKeyTitle: "API Key",
            apiKeyDesc: "Add your own DeepSeek API Key to use custom models and bypass the free quota.",
            apiKeyPlaceholder: "sk-...",
            apiKeySaving: "Saving…",
            apiKeySave: "Save",
            apiKeySaved: "Saved ✓",
            apiTitle: "Account & Quota",
            apiSub: "(Add your own DeepSeek API Key for unlimited usage)",
